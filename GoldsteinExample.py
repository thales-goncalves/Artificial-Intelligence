...
class Goldstein(object):
    ...
    def Goldstein_Function(self, x1,x2):
    ...
    def getFitness(self,individual):
        ...
        #print(self.Goldstein_Function(real_x1,real_x2))
        fitness = 10.0/(1.0+self.Goldstein_Function(real_x1,real_x2))
        #print(fitness)
        return fitness
    ...
    def printSolution(self,solution):
        ...
        print('x1=%g'%real_x1)
        print('x2=%g'%real_x2)
        print('f(x1,x2)=%g'%self.Goldstein_Function(real_x1,real_x2))